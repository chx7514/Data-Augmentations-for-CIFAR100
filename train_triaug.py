...
if args.resume:
    ...
    assert os.path.isfile('./best_model_triaug_' + args.model + '.pth'), 'Error: no checkpoint directory found!'
    checkpoint = torch.load('./best_model_triaug_' + args.model + '.pth')
...
path = os.path.join('./path/to/log/triaug', args.model)
...
for epoch in range(start_epoch, num_epochs):
    ...
    if is_best:
        ...
        'acc': best_acc,
        }, False, 'best_model_triaug_' + args.model + '.pth')
